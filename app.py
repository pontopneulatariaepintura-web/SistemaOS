...
ETIQUETA_PECA_TEMPLATE = '<!DOCTYPE html>\n<html lang="pt-br">\n<head>\n    <meta charset="UTF-8">\n    <title>Etiqueta {{ peca.nome }}</title>\n    <style>\n        @page { size: 50mm 30mm; margin: 2mm; }\n        * { box-sizing: border-box; }\n        body { margin: 0; font-family: Arial, Helvetica, sans-serif; color: #000; }\n        .etiqueta { width: 46mm; height: 26mm; display: flex; flex-direction: column; justify-content: space-between; gap: .8mm; overflow: hidden; }\n        .topo-etiqueta { display: flex; align-items: center; gap: 1.5mm; min-height: 6mm; }\n        .logo-etiqueta { width: 6mm; height: 6mm; object-fit: contain; }\n        .loja { font-size: 7px; font-weight: 700; line-height: 1.05; text-transform: uppercase; }\n        .descricao { font-size: 9px; font-weight: 700; line-height: 1.05; max-height: 6mm; overflow: hidden; }\n        .meta { font-size: 7px; line-height: 1.05; display: flex; justify-content: space-between; gap: 2mm; }\n        .barcode { height: 8mm; display: flex; align-items: stretch; gap: 0; justify-content: center; }\n        .bar { height: 8mm; display: inline-block; }\n        .black { background: #000; }\n        .white { background: #fff; }\n        .codigo { font-size: 8px; text-align: center; letter-spacing: .8px; line-height: 1; }\n        .no-print { margin: 12px; }\n        .btn { display: inline-block; padding: 9px 14px; border-radius: 7px; background: #2563eb; color: white; text-decoration: none; font-weight: bold; border: 0; cursor: pointer; }\n        @media print { .no-print { display: none; } }\n    </style>\n</head>\n<body>\n    <div class="no-print">\n        <button class="btn" onclick="window.print()">Imprimir etiqueta</button>\n    </div>\n    <div class="etiqueta">\n        <div class="topo-etiqueta">\n            <img class="logo-etiqueta" src="{{ url_for(\'static\', filename=\'logo-ponto-pneu.png\') }}" alt="Ponto Do Pneu Auto Center">\n            <div class="loja">Ponto Do Pneu<br>Auto Center</div>\n        </div>\n        <div class="descricao">Produto: {{ peca.nome }}</div>\n        <div class="meta"><span>Qtd: {{ peca.quantidade or 0 }}</span><span>Emiss&atilde;o: {{ data_emissao }}</span></div>\n        <div class="barcode" aria-label="Codigo de barras {{ codigo_original }}">\n            {% for barra in barras %}\n            <span class="bar {% if barra.preta %}black{% else %}white{% endif %}" style="width: {{ barra.largura }}px"></span>\n            {% endfor %}\n        </div>\n        <div class="codigo">{{ codigo_original }}</div>\n    </div>\n    {% if auto %}\n    <script>\n        window.addEventListener("load", function () {\n            setTimeout(function () { window.print(); }, 400);\n        });\n    </script>\n    {% endif %}\n</body>\n</html>\n'
